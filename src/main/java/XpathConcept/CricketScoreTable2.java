...
public class CricketScoreTable2 {
	...
	public static void main(String[] args) {
		...
		driver.get("https://www.espncricinfo.com/series/icc-men-s-t20-world-cup-2021-22-1267897/namibia-vs-scotland-21st-match-group-2-1273732/full-scorecard");
...
//		}
	...
	public static void getScoreList(WebDriver driver,String playerName) {
		...
		List<WebElement> scoreList=driver.findElements(By.xpath("//a[text()='"+playerName+"']//parent::td//following-sibling::td[@class='text-left']//following-sibling::td"));
